  ...
  <section id="contact" class="relative pt-28 lg:pt-36">
    <div class="container px-3 mx-auto max-w-6xl 2xl:max-w-7xl">
      <div class="grid grid-cols-1">
        <div class="bg-gradient-to-r from-slate-800 via-slate-900 to-slate-800 shadow-md rounded-lg py-7 px-5 md:py-14 md:px-20 flex flex-col items-center justify-center relative">
          ...
          <LinkButton target="_blank" link="https://mail.google.com/mail/?view=cm&amp;fs=1&amp;to=dfahimanzam@gmail.com&amp;&amp;su=Need to disscuss with Mr. Fahim&amp;body=Hello, I need to talk about a project" class="px-5 py-3 text-md md:text-lg">
            <span class="tracking-wide">Hire Me</span>
            <template #icon>

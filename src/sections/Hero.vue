  ...
  <section id="home" class="relative min-h-[calc(100vh-85px)] overflow-x-clip bg-slate-100 dark:bg-[#0B1120]">
    ...
    <div class="container mx-auto px-3 flex flex-col justify-center items-center min-h-[calc(100vh-85px)] max-w-6xl 2xl:max-w-7xl">
      <h1 v-motion
          ...
          class="text-4xl md:text-6xl lg:text-8xl font-bold font-heading dark:text-slate-100 mb-5 text-center">I'm <span class="bg-clip-text text-transparent bg-gradient-to-r from-sky-500 to-purple-500 dark:from-sky-400 dark:to-teal-400">Fahim Anzam</span></h1>
      <h2 v-motion
          :initial="{
            opacity: 0,
          }"
          ...
          class="text-2xl md:text-5xl font-semibold font-heading dark:text-slate-100 text-center"><span ref="typedElement"></span></h2>
      ...
      <div v-motion
        ...
        <LinkButton link="#about" class="text-sm md:text-xl px-5 py-3 md:px-7 md:py-4">
          About Me
        </LinkButton>

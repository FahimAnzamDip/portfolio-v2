...
<template>
  ...
  <template v-if="loadMobileNav">
    <nav v-show="mobileNav" class="py-5 fixed bottom-0 left-0 right-0 bg-[#0B1120]/80 shadow backdrop-blur-xl z-40 block md:hidden">
      <ul v-scroll-spy-active="{selector: 'li a.menu-link', class: 'text-primary-400'}" class="grid grid-cols-4 gap-6 px-5">
        <li  class="flex justify-center items-center">
          <a v-smooth-scroll href="#home" class="menu-link">
        ...
        <li class="flex justify-center items-center">
          <a v-smooth-scroll href="#about" class="menu-link">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
        ...
        <li class="flex justify-center items-center">
          <a v-smooth-scroll href="#works" class="menu-link">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
        ...
        <li class="flex justify-center items-center">
          <a v-smooth-scroll href="#contact" class="menu-link">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
